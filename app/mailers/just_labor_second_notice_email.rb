...
class JustLaborSecondNoticeEmail
  def send(job)
...
If not you will be reminded again in 2 days.
*Please note, there are 2 days remaining to file this NOI. If that time elapses you will lose the right to file a lien.
