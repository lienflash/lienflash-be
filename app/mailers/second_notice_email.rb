...
class SecondNoticeEmail
  def send(job)
    ...
    content = Content.new(type: 'text/plain', value:
      "The job located at: #{job.job_site_address} #{job.job_site_city}, #{job.job_site_state} #{job.job_site_zip_code} has been unpaid for 75 days.
...
If not you will be reminded again in 15 days.
*Please note, there are 30 days remaining to file this NOI. If that time elapses you will lose the right to file a lien.
